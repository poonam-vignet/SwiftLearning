...
class ContactsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let contactCell =  tableView.dequeueReusableCell(withIdentifier: "ContactCustomCell", for: indexPath) as! ContactsTableViewCell
        contactCell.contactImage.layer.masksToBounds = true
        contactCell.contactImage.layer.cornerRadius = 22;
        contactCell.contactImage.image = UIImage(named : "defaultImage")
        contactCell.ContactName.text = "Poonam Bhadikar"
        contactCell.workingPlace.text = "Vignet"
